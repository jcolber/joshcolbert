    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <h1 class="my-4"><img src="../img/yonahoutdoors_logo-06.png"/></h1>
                <div class="list-group">
                    <a href="#" class="list-group-item">Hammocks</a>
                    <a href="#" class="list-group-item">Shirts</a>
                    <a href="#" class="list-group-item">Straps</a>
                </div>
                ...
                <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="carousel-item">
                            <img class="d-block img-fluid" src="../img/girls.jpg" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100">
                            <a href="shop-item/index.php"><img class="card-img-top img-fluid" src="../img/hammock.jpg" alt=""></a>
                            <div class="card-block">
                                <h4 class="card-title"><a href="shop-item/index.php">Item One</a></h4>
                                <h5>$24.99</h5>
